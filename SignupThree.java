...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno)
    {
        ...
        JLabel number=new JLabel("XXXX-XXXX-XXXX-2334");
        ...
        carddetail.setBounds(100,230,300,30);
        add(carddetail);
        ...
        pdetail.setBounds(100,300,300,30);
        add(pdetail);
        ...
        c3.setBounds(100,450,200,20);
        add(c3);
        
        c4= new JCheckBox("EMAIL & SMS ALERT");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway",Font.BOLD,16));
        c4.setBounds(350,450,200,20);
        add(c4);
        ...
        c7= new JCheckBox("I hereby declares that above enters details are correct to best of my knowledge."); 
        ...
        */
        try
        {
           ...
           else
           {
               ...
               JOptionPane.showMessageDialog(null,"Ypur Card Number is "+cardnumber+"\n PIN Number is "+pinnumber);
               setVisible(true);
